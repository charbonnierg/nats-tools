...
from .protocol import NATSMonitor, AsyncNATSMonitor, SortOption, StateOption, SubsOption


class HTTPNATSMonitor(NATSMonitor):
...
class AsyncHTTPNATSMonitor(AsyncNATSMonitor):
    def __init__(self, endpoint: str) -> None:
        self.endpoint = endpoint
